...
import com.example.test1.jwt.CustomLogoutFilter;
import com.example.test1.jwt.JWTFilter;
import com.example.test1.jwt.JwtUtil;
import com.example.test1.jwt.LoginFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        http.authorizeHttpRequests((auth)->auth
                ...
                .requestMatchers("/basicProfile/test").permitAll()
